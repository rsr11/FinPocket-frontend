      ...
      return;
       ...
       try {
          //  alert(email+" "+ password);
            ...
            if(data.status === 200){
              dispatch(UpdateLoggedIn({name:data?.data?.name || "User" ,email,isLoggedIn:true}));
              setLoading(false);
  ...
  return (
    ...
    <div className='flex justify-center flex-col items-center h-[70vh]' >
      ...
      {/* <h1 className='absolute sm:left-24 left-2 text-xl sm:text-2xl top-1 sm:top-8 p-4' >FinPocket 🪙 </h1> */}
       ...
       <form onSubmit={(e)=>{onLoginSubmit(e)}} className='flex flex-col w-[80vw] lg:w-[30vw] md:w-[60vw] sm:w-[30vw] rounded-md shadow-2xl  pt-20 p-5' >
